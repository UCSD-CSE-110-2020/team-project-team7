...
public class CancelTeamMateTest {
    ...
    @Test
    public void cancelTeamMateTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.teammateName), withText("Cindy Do"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Cindy Do")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.teammateName), withText("Cindy Do"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("Cindy Do")));
    }
