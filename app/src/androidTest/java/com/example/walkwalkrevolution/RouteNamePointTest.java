...
public class RouteNamePointTest {
    ...
    public void routeNamePointTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.routeNameEditText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Gary "), closeSoftKeyboard());
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.routeNameEditText), withText("Gary "),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.routeNameStartingLayout),
                                        0),
                                1),
                        isDisplayed()));
        editText.check(matches(withText("Gary ")));

        ViewInteraction editText2 = onView(
                allOf(withId(R.id.startingPEditText), withText("Start"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.routeNameStartingLayout),
                                        1),
                                1),
                        isDisplayed()));
        editText2.check(matches(withText("Start")));
        ...
        ViewInteraction editText3 = onView(
                allOf(withId(R.id.startingPEditText), withText("Start"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        editText3.check(matches(withText("Start")));
    }
